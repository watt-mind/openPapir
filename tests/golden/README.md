...
| `<root>` | The temporary directory the case was built in, which appears only in the human output of the export and import commands, because those lines repeat the `--to` or `--from` argument the user typed. |
